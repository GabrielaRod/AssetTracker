...
public class AssetRegistration extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            buttonSubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String vin, make, model, year, tagid;
                    ...
                    if(!vin.equals("") && !make.equals("") && !model.equals("") && !year.equals("") && !tagid.equals("")){
                        ...
                        handler.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                data[2] = model;
                                data[3] = year;
                                data[4] = color.toString();
                                data[5] = type.toString();
                                data[6] = tagid;
                                Log.v("log", data[4]);
                                ...
                                if (putData.startPut()) {
                                    if (putData.onComplete()) {
                                        ...
                                        if(result.equals("Registration Successful")){
                                            Intent intent = new Intent(getApplicationContext(), MainActivity.class); //If success it will take you to MainActivity
                                            startActivity(intent);
                                            finish();
                                        }
                                    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        String typechoice = parent.getItemAtPosition(position).toString();
        Toast.makeText(getApplicationContext(), typechoice, Toast.LENGTH_SHORT).show();

        String colorchoice = parent.getItemAtPosition(position).toString();
